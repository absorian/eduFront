<script lang="ts">
    ...
    function request_comic(id: string) {
        ...
        .then((res) => {
            ...
            date_published = `Published ${formatDistanceToNow(new Date(res.year, res.month, res.day))} ago`;
        })
    }

</script>

<ColumnTable sizes={[{percentage: 62, min_size: "500px"}, {percentage: 38, min_size: "360px", max_size: "450px"}]}>
<Box slot="1">
