...
<ColumnTable sizes={[{percentage: 62, min_size: "38vw"}, {percentage: 38, min_size: "300px"}]}>
    <Box slot="1" shadow>
    ...
    <Box slot="2" shadow>
        <form id="msg_form" on:submit|preventDefault={sendMessage}>
            <input bind:value={form_msg.username} class="input_user shadow" type="text" placeholder="User" minlength="2" autocomplete="off" required>
            <span bind:innerText={form_msg.content} on:keypress={handleTextboxEnter} tabindex="0"
                class="input_content shadow" role="textbox" contenteditable="plaintext-only"></span>
            <div>
